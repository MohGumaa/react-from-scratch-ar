const TaskList = () => {
  ...
  return (
    <div className='bg-gray-900 scheme-dark mx-auto max-w-7xl py-12 sm:px-6 lg:px-8 rounded-md border border-white/10'>
        ...
        {tasks.map((task, index) => {
          return (
            <div className="px-4 py-6 sm:px-0">
              <dt key={index} className="text-sm/6 font-medium text-gray-100">{task}</dt>
            </div>
          )
        })}
      </dl>
